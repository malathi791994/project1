...
<table >
	<form:form action="./saveProduct"  commandName="prod" method="POST" enctype="multipart/form-data">
		...
		<div class="col-sm-2">
			...
			<td><form:input path="price" class="form-control" pattern="[0-9].{2,}" title="It should be digits" required="true"/></td>
		</tr>
		<br>
			<tr>
			<td>supplier</td>
	...
	<tr>
		<div class="col-sm-2">
			...
			<td><form:input path="quantity" class="form-control" pattern="[0-9].{0,}" required="true"/></td>
		</tr>
		<br>
	<tr>
