...
<!-- /.container -->
 ...
 <ul class="list-inline intro-social-buttons">
   ...
   <a href="memberShip" class="btn btn-default btn-lg">

 <span class="network-name">SIGNUP</span></a>
                        
    </li> -->
                            <li>
                        
        <a href="page4" class="btn btn-default btn-lg">

</i> <span class="network-name">PRODUCT</span></a>
                        
    </li>
                      <!--       <li>
                            
    <a href="page4" class="btn btn-default btn-lg">
<span class="network-name">PRODUCT</span></a>
...
<li>Mobile port</li></h3>
          ...
          <img class="img-responsive" src="<c:url value='/resource/img/chlm1.jpg'/>" alt="">
                </div>
            </div>
