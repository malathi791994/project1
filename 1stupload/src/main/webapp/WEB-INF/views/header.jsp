...
<link
	href="<c:url value='/resource/bootstrap-3.3.6-dist/css/bootstrap-theme.min.css'/>"
	rel="stylesheet">
<link
	href="<c:url value='/resource/bootstrap-3.3.6-dist/css/bootstrap.min.css'/>"
	rel="stylesheet">
<!-- Custom CSS -->
<link
	href="<c:url value='/resource/bootstrap-3.3.6-dist/css/landing-page.css'/>"
	rel="stylesheet">
<!-- Custom Fonts -->
<link
	href="<c:url value='/resource/bootstrap-3.3.6-dist/font-awesome/css/font-awesome.min.css'/>"
...
<script
	src="<c:url value='/resource/bootstrap-3.3.6-dist/js/jquery.min.js'/>"></script>
<script
	src="<c:url value='/resource/bootstrap-3.3.6-dist/js/bootstrap.min.js'/>"></script>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li><security:authorize access="hasRole('ROLE_ADMIN')">
							<a href="/pendrive/adminlogin">AdminHome</a>
...
<a href="#abt">About</a>
					...
					<li><a href="page4">Product</a></li>

					<!-- <li>
                        
<a href="EmailForm">mail</a>
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<c:forEach items="${cList}" var="c">
								<li><a commandName="cat" href="page5?id=${c.cid}">
										${c.name}</a></li>
							</c:forEach>
						</ul></li>
